...
class BrandSeeder extends Seeder
{
    public function run()
    {
        $brands = [
            ...
            ['name' => 'Dji Mavic', 'image' => asset('storage/Brand/dji.jpg')],
            ['name' => 'ROLAND', 'image' => asset('storage/Brand/roland.jpg')],
            ['name' => 'Stumpjumper', 'image' => asset('storage/Brand/stumpjumper.jpg')],
            ['name' => 'Razer Blade', 'image' => asset('storage/Brand/razer.jpg')],
            ['name' => 'Google Pixel', 'image' => asset('storage/Brand/google.jpg')],
            ...
            ['name' => 'SANTA CRUZ', 'image' => asset('storage/Brand/santa-cruz.jpg')],
